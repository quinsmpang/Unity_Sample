...
public class SimpleFramework_Manager_PanelManagerWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "SimpleFramework.Manager.PanelManager", typeof(SimpleFramework.Manager.PanelManager), regs, fields, typeof(SimpleFramework.BehaviourBase));
	}
