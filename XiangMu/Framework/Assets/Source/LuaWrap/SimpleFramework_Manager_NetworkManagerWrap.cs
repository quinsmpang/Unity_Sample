...
public class SimpleFramework_Manager_NetworkManagerWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "SimpleFramework.Manager.NetworkManager", typeof(SimpleFramework.Manager.NetworkManager), regs, fields, typeof(SimpleFramework.BehaviourBase));
	}
