...
public class SimpleFramework_Manager_TimerManagerWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaScriptMgr.RegisterLib(L, "SimpleFramework.Manager.TimerManager", typeof(SimpleFramework.Manager.TimerManager), regs, fields, typeof(SimpleFramework.BehaviourBase));
	}
